/**
 * User profile cache (name, phone) persisted to AsyncStorage.
 */
...
export type AppUser = { name: string; phone: string };
...
export function UserProvider({ children }: { children: React.ReactNode }) {
  ...
  const value: UserContextValue = { user, isRestored, setUser, clearUser };
