/**
 * Home / Create Entry: Staff vs Driver Partner toggle + visitor form.
 * Next → VisitorPurpose → TokenDisplay.
 */
...
import type { RootStackParamList, EntryType, EntryFormData } from "@/navigation/types";
import {
  normalizePhoneInput,
  isPhoneValid,
  PHONE_MAX_DIGITS,
...
function SegmentedToggle({
  ...
  React.useEffect(() => {
    translateX.value = withSpring(tabIndex, { damping: 20, stiffness: 200 });
  }, [tabIndex]);
    ...
    >
      <View style={styles.toggleTrack}>
        ...
        <View style={styles.toggleTabsRow}>
          ...
          >
            <Text style={[styles.toggleLabel, value === "staff" && styles.toggleLabelActive]}>
              Staff
            </Text>
          </Pressable>
          <Pressable
          ...
          >
            <Text style={[styles.toggleLabel, value === "driver_partner" && styles.toggleLabelActive]}>
              Driver Partner
            </Text>
          </Pressable>
        </View>
...
const styles = StyleSheet.create({
  ...
  keyboardView: { flex: 1 },
  scrollView: { flex: 1 },
  scrollContent: { flexGrow: 1, paddingHorizontal: HORIZONTAL_PADDING, paddingBottom: 24 },
  illustrationWrap: {
    alignItems: "center",
  ...
  illustration: { width: "95%", height: 160 },
  title: {
  ...
  toggleTabsRow: { flexDirection: "row", flex: 1 },
  toggleTab: { flex: 1, justifyContent: "center", alignItems: "center" },
  togglePillSlider: {
    position: "absolute",
    left: 4,
    top: 4,
  ...
  toggleLabelActive: { fontWeight: "600", color: TOGGLE_ACTIVE_COLOR },
  formSection: { paddingHorizontal: 0 },
  field: { gap: 8 },
  label: {
    fontFamily: fontFamily.poppins,
    fontSize: 14,
  ...
  nextButtonDisabled: { backgroundColor: "#D4D8DA", opacity: 0.8 },
  ...
  nextButtonTextDisabled: { color: "#77878E" },
});
