...
import {
  View, StyleSheet, ScrollView, Pressable, ActivityIndicator, Modal,
} from "react-native";
...
type NavProp = NativeStackNavigationProp<RootStackParamList, "MaintenancePurpose">;
...
export default function MaintenancePurposeScreen() {
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={["bottom"]}>
      ...
      <Modal visible={showRRModal} transparent animationType="fade" onRequestClose={() => setShowRRModal(false)}>
        <View style={[styles.modalOverlay, { backgroundColor: theme.overlayBackdrop }]}>
          ...
          >
            <View style={styles.modalHeader}>
              ...
              <ThemedText type="h4" style={[styles.modalTitle, { color: theme.text }]}>Running Repair</ThemedText>
                ...
                {rrSubItems.map((sub, i) => (
                  <Animated.View key={sub.key} entering={FadeInDown.delay(i * 55).springify()}>
                    ...
                    >
                      ...
                      <ThemedText type="body" style={[styles.modalItemLabel, { color: theme.text }]}>{sub.label}</ThemedText>
...
const styles = StyleSheet.create({
  ...
  modalCard: { borderRadius: BorderRadius.md + 4, padding: Spacing.lg, shadowColor: "#000", shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.15, shadowRadius: 20, elevation: 20 },
  modalHeader: { flexDirection: "row", alignItems: "center", marginBottom: Spacing.sm, gap: Spacing.sm },
  modalIconWrap: { width: 34, height: 34, borderRadius: 10, backgroundColor: D.brandRedMid, alignItems: "center", justifyContent: "center" },
  modalTitle: { flex: 1, fontWeight: "700" },
  modalSubtitle: { marginBottom: Spacing.md, paddingLeft: 42, fontSize: 13 },
  modalItem: { flexDirection: "row", alignItems: "center", paddingVertical: Spacing.md, paddingHorizontal: Spacing.md, borderRadius: BorderRadius.md, borderWidth: 1.5 },
  modalItemIcon: { width: 30, height: 30, borderRadius: 8, backgroundColor: D.brandRedMid, alignItems: "center", justifyContent: "center", marginRight: Spacing.sm },
