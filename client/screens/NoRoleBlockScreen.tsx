 ...
 * Global role check: block access; single action (Logout).
 */
  ...
  return (
    <ThemedView style={styles.container}>
      <View style={styles.content}>
        <Feather name="shield-off" size={48} color={theme.textSecondary} style={styles.icon} />
        <ThemedText type="h1" style={styles.title}>
          Access denied
        </ThemedText>
        <ThemedText type="body" style={[styles.message, { color: theme.textSecondary }]}>
          Your account does not have permission to use this app. Please contact Carrum Support.
        </ThemedText>
        <Pressable
